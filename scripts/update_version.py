...
def main():
  ...
  plistpath = scriptpath + "/resources/FMSU-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FMSU-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FMSU-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FMSU-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FMSU-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/FMSU.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/FMSU.iss",inplace=1):
