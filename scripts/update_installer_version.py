...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=FMSU Demo Installer\n"
      else:
        line="OutputBaseFilename=FMSU Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the FMSU Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the FMSU installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=FMSU Demo installer\n"
     else:
       line="SetupWindowTitle=FMSU installer\n"
